...
console.log("bolo_preco é igual a ", bolo_preco ) 
...
if(idadeVotar >= 88){
    ...
    // CORREÇÃO 2: Adicionado o ponto (.) que faltava em console.log
    console.log('Não Permitido para votar')
}


// Exemplo sobre as diferenças de == e ===

let idadeMinimaObg = 18;
let idadeDigitada = "18";

if(idadeDigitada == idadeMinimaObg){
...
let idadeFesta = 18;
let convite = true;
let estaNaLista = false; // Adicionada a variável que faltava para testar o OU

// CORREÇÃO 3: Removido o || solto do final e adicionado os parênteses obrigatórios para isolar o OU
if(idadeFesta >= 18 && (convite || estaNaLista)) { 
